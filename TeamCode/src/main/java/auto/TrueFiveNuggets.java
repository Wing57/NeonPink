...
@Autonomous(name = "True 5 nugget", group = "Examples")
public class TrueFiveNuggets extends ActionOpMode {
    ...
    public PathChain scorePreload, scoreSecond, firstFerry, secondFerry, thirdFerry, scoreFirst, grabFirst, grabSecond, grabThird, scoreThird, park;
    ...
    public void buildPaths() {
        ...
        firstFerry = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(42.000, 70.000, Point.CARTESIAN),
                        ...
                        new Point(32, 31, Point.CARTESIAN)))
                .addTemporalCallback(0.3, ()-> run(new ParallelAction(liftActions.liftA.extendZero(), servoActions.armA.sweepDown())))
                .setConstantHeadingInterpolation(0)
                .addPath(new BezierLine(
                                new Point(32.000, 31, Point.CARTESIAN),
                                new Point(25.000, 31, Point.CARTESIAN)
                        )
                )
